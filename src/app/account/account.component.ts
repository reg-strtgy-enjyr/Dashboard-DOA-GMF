...
export class AccountComponent implements OnInit {
  ...
  async getAccountInfo() {
    try {
      const response = await axios.post('https://34.132.47.129/account/show', { accountid: this.accountid });
  ...
  async fetchAllAccounts() {
    try {
        const response = await axios.get('https://34.132.47.129/account/show-all');
  ...
  async changePassword() {
    try {
        const response = await axios.post('https://34.132.47.129/account/update-password', {
  ...
  async deleteAccount() {
    try {
        const response = await axios.post('https://34.132.47.129/account/delete', {
