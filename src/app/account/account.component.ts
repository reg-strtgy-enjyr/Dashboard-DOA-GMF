...
export class AccountComponent implements OnInit {
  ...
  async getAccountInfo() {
    try {
      const response = await axios.post('http://34.132.47.129:4040/account/show', { accountid: this.accountid });
  ...
  async fetchAllAccounts() {
    try {
        const response = await axios.get('http://34.132.47.129:4040/account/show-all');
  ...
  async changePassword() {
    try {
        const response = await axios.post('http://34.132.47.129:4040/account/update-password', {
  ...
  async deleteAccount() {
    try {
        const response = await axios.post('http://34.132.47.129:4040/account/delete', {
