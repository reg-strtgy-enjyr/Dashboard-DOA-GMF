...
export class DetailPersonnelComponent implements OnInit {
  ...
  async fetchPersonnel() {
    try {
      const response = await axios.post('http://34.46.32.81:4040/personnel/show', 
  ...
  async addEducation() {
    ...
    try {
      ...
      const response = await axios.post('http://34.46.32.81:4040/personnel/education/add', this.newEducation);
  ...
  async editEducation(education: Education) {
    ...
    try {
      ...
      const response = await axios.put('http://34.46.32.81:4040/personnel/education/update', education);
      if (response.data.status === 200) {
  ...
  async addTraining() {
    ...
    try {
      ...
      const response = await axios.post('http://34.46.32.81:4040/personnel/training/add', this.newTraining);
      if (response.data.status === 200) {
  ...
  async editTraining(training: Training) {
    ...
    try {
      ...
      const response = await axios.put('http://34.46.32.81:4040/personnel/training/update', training);
      if (response.data.status === 200) {
  ...
  async addExperience() {
    ...
    try {
      ...
      const response = await axios.post('http://34.46.32.81:4040/personnel/experience/add', this.newExperience);
      if (response.data.status === 200) {
  ...
  async editExperience(experience: Experience) {
    ...
    try {
      ...
      const response = await axios.put('http://34.46.32.81:4040/personnel/experience/update', experience);
      if (response.data.status === 200) {
  ...
  async addCert() {
    ...
    try {
      ...
      const response = await axios.post('http://34.46.32.81:4040/personnel/cert/add', this.newCert);
      if (response.data.status === 200) {
  ...
  async editCert(cert: Certification) {
    ...
    try {
      ...
      const response = await axios.put('http://34.46.32.81:4040/personnel/cert/update', cert);
      if (response.data.status === 200) {
