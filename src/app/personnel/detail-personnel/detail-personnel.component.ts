...
export class DetailPersonnelComponent implements OnInit {
  ...
  async addEducation() {
    ...
    try {
      ...
      const response = await axios.post('https://34.132.47.129/personnel/education/add', this.newEducation);
  ...
  async editEducation(education: Education) {
    ...
    try {
      ...
      const response = await axios.put('https://34.132.47.129/personnel/education/update', education);
      if (response.data.status === 200) {
  ...
  async addTraining() {
    ...
    try {
      ...
      const response = await axios.post('https://34.132.47.129/personnel/training/add', this.newTraining);
      if (response.data.status === 200) {
  ...
  async editTraining(training: Training) {
    ...
    try {
      ...
      const response = await axios.put('https://34.132.47.129/personnel/training/update', training);
      if (response.data.status === 200) {
  ...
  async addExperience() {
    ...
    try {
      ...
      const response = await axios.post('https://34.132.47.129/personnel/experience/add', this.newExperience);
      if (response.data.status === 200) {
  ...
  async editExperience(experience: Experience) {
    ...
    try {
      ...
      const response = await axios.put('https://34.132.47.129/personnel/experience/update', experience);
      if (response.data.status === 200) {
  ...
  async addCert() {
    ...
    try {
      ...
      const response = await axios.post('https://34.132.47.129/personnel/cert/add', this.newCert);
      if (response.data.status === 200) {
  ...
  async editCert(cert: Certification) {
    ...
    try {
      ...
      const response = await axios.put('https://34.132.47.129/personnel/cert/update', cert);
      if (response.data.status === 200) {
