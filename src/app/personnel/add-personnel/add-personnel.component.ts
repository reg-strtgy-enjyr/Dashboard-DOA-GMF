...
export class AddPersonnelComponent implements OnInit {
  ...
  async submitPersonnel() {
    ...
    try {
      const response = await axios.post('http://34.46.32.81:4040/personnel/add', this.personnelData);
  ...
  async submitEducation() {
    try {
      for (let i = 0; i < this.educations.length; i++) {
        ...
        const response = await axios.post('http://34.46.32.81:4040/personnel/education/add', this.educations[i]);
        if (response.data.status !== 200) {
  ...
  async submitTraining() {
    try {
      for (let i = 0; i < this.trainingRecords.length; i++) {
        ...
        const response = await axios.post('http://34.46.32.81:4040/personnel/training/add', this.trainingRecords[i]);
        if (response.data.status !== 200) {
  ...
  async submitExperience() {
    try {
      for (let i = 0; i < this.experienceRecords.length; i++) {
        ...
        const response = await axios.post('http://34.46.32.81:4040/personnel/experience/add', this.experienceRecords[i]);
        if (response.data.status !== 200) {
  ...
  async submitCertificate() {
    try {
      for (let i = 0; i < this.certifications.length; i++) {
        ...
        const response = await axios.post('http://34.46.32.81:4040/personnel/cert/add', this.certifications[i]);
        if (response.data.status !== 200) {
